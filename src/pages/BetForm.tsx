  ...
  return (
    <div>
      <PageHeader 
        ...
        subtitle={isEditing ? "Atualize os detalhes da aposta" : "Adicione uma nova aposta"}
        breadcrumbs={[
          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Select value={type} onValueChange={(value) => setType(value as BetType)}>
                  <SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    setCommission(value === '' ? undefined : parseFloat(value) || 0);
                  }}
                />
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-lg font-semibold">
                      {profitCurrency >= 0 ? '+' : ''}{profitCurrency.toFixed(2)}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm">Lucro (unidades)</p>
                    <p className="text-lg font-semibold">
                      {profitUnits >= 0 ? '+' : ''}{profitUnits.toFixed(2)}
                    </p>
                  </div>
                </div>
              </div>
